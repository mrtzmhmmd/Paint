...
public class zoom extends javax.swing.JPanel {
	...
	private void updatePreferredSize(int n, Point p) {
		if (n == 0) // ideally getWheelRotation() should never return 0.
			n = -1 * prevN; // but sometimes it returns 0 during changing of
							// zoom
							// direction. so if we get 0 just reverse the
							// direction.
		...
		// in the original code, zoomPanel is being shifted. here we are
